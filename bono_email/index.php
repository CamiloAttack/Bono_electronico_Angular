                ...
                $html.="<div style='border: 1px #999999 solid; background: #FFFFFF; margin: 0px; margin-bottom: 10px; border-radius: 5px; padding-right:15px;padding-left: 15px;'>";
                   $html.="<table style='width: 100%; max-width: 100%;border-spacing: 0; border-collapse: collapse; text-align:center; font-size:10px;color:#333 '>";
                    ...
                    foreach ($value as $k => $v) {
                      ...
                      $aporteFinanciador = ($v['aporteFinanciador']) ? $v['aporteFinanciador'] : "0";
                      ...
                      $html.="<tr >";
                        ...
                        $html.="<td style='border-top: 0px solid #ddd;width:17% ;border-right:1px #999999 solid;text-align:right;padding-right:5px;'>$".$aporteFinanciador."</td>";
                     ...
                     $html.="<tbody>";
                        ...
                        $html.="<tr >";
                           $html.="<td  style='padding: 0px;  text-align: center; width: 100%; height: 20px;border: 0px black solid;'>";
                               ...
                               $html.="<tbody>";
                                  $html.="<tr>";
                                     $html.="<td style='border-top: 0px solid #ddd;width:24% ;border-right:1px #999999 solid;text-align:center;height:29px'>";
                                     $html.="ISAPRE : $".$datosBonificacionTotales[$key]." </td>";
                                     $html.="<td style='border-top: 0px solid #ddd;width:24% ;border-right:1px #999999 solid;text-align:right;padding-right:5px;text-align:center;'>COMPAÑIA DE SEGURO : $0</td>";
                                     $html.="<td style='border-top: 0px solid #ddd;width:24% ;border-right:1px #999999 solid;text-align:right;padding-right:5px;text-align:center;'>CCAF :  $0</td>";
                        ...
                        $html.="<tr>";
                           $html.="<td style='padding: 0px; height: 35px; text-align: center; width: 33%; height: 0px; ;border-right: 1px #999999 solid;'>";
                              $html.="<div style='float: left;  height: 90px; width: 100%; '>";
                                 ...
                                 $html.="<div style='border-bottom: 1px #999999 solid;text-align:center;'>".$datosUsuario['nombreRazonSocialSucursal']." ".$datosUsuariorazonSocialRut."</div>";
...
$mail->Port = 465;
$mail->Username = "desarrollo.openpartner@gmail.com";
$mail->Password = "desarrolloopenpartner123";

$mail->From = "desarrollo.openpartner@gmail.com";
$mail->FromName = "Bono email";
$mail->Subject = "Bono Medipass de ".$datosBeneficiario['nombre'] ." ".$datosBeneficiario['apellidoPaterno'];
$mail->AltBody = "";
$mail->MsgHTML($html);
 
$mail->AddAddress($_POST['emailEnvio'], "Nombre Destinatario");
