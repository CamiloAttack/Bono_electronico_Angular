...
function SOAPClientParameters()
{
	...
	this.toXml = function()
	{
		...
		for(var p in _pl){
			...
			//"ns:responseCode" responseDescription
			...
			if(name_if_rut === "urn:rut"){ // si es urn:rut
				...
				if(p =="urn:codigo"){ // concateno   "<urn:prestaciones>"

					xml +="<urn:prestaciones>";
				}

				xml += "<" + p + ">" + SOAPClientParameters._serialize(_pl[p]) + "</" + p + ">";

				if(p =="urn:valor"){ // concateno   "</urn:prestaciones>"
